...
static const _CustomMessage1_type_support_symbol_names_t _CustomMessage1_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_custom_multi_dep_pkg_test, msg, CustomMessage1)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, multi_custom_multi_dep_pkg_test, msg, CustomMessage1)),
  }
};
...
{
  return &::multi_custom_multi_dep_pkg_test::msg::rosidl_typesupport_cpp::CustomMessage1_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, multi_custom_multi_dep_pkg_test, msg, CustomMessage1)() {
  return get_message_type_support_handle<multi_custom_multi_dep_pkg_test::msg::CustomMessage1>();
}
