...
static const _CustomMessage0_type_support_symbol_names_t _CustomMessage0_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, multi_custom_multi_dep_pkg_test, msg, CustomMessage0)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_custom_multi_dep_pkg_test, msg, CustomMessage0)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, multi_custom_multi_dep_pkg_test, msg, CustomMessage0)() {
  return &::multi_custom_multi_dep_pkg_test::msg::rosidl_typesupport_c::CustomMessage0_message_type_support_handle;
}
