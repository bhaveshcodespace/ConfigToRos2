...
#include "single_custom_multi_dep_pkg_test/msg/detail/custom_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_single_custom_multi_dep_pkg_test
cdr_serialize(
  const single_custom_multi_dep_pkg_test::msg::CustomMessage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  single_custom_multi_dep_pkg_test::msg::CustomMessage & ros_message)
{
  // Member: center
...
{
  auto typed_message =
    static_cast<const single_custom_multi_dep_pkg_test::msg::CustomMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<single_custom_multi_dep_pkg_test::msg::CustomMessage *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_single_custom_multi_dep_pkg_test
const rosidl_message_type_support_t *
get_message_type_support_handle<single_custom_multi_dep_pkg_test::msg::CustomMessage>()
{
  return &single_custom_multi_dep_pkg_test::msg::typesupport_fastrtps_cpp::_CustomMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, single_custom_multi_dep_pkg_test, msg, CustomMessage)() {
  return &single_custom_multi_dep_pkg_test::msg::typesupport_fastrtps_cpp::_CustomMessage__handle;
}
