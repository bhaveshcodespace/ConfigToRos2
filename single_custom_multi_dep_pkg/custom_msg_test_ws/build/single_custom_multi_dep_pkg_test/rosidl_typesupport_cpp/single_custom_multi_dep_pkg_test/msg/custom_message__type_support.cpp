...
static const _CustomMessage_type_support_symbol_names_t _CustomMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, single_custom_multi_dep_pkg_test, msg, CustomMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, single_custom_multi_dep_pkg_test, msg, CustomMessage)),
  }
};
...
{
  return &::single_custom_multi_dep_pkg_test::msg::rosidl_typesupport_cpp::CustomMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, single_custom_multi_dep_pkg_test, msg, CustomMessage)() {
  return get_message_type_support_handle<single_custom_multi_dep_pkg_test::msg::CustomMessage>();
}
