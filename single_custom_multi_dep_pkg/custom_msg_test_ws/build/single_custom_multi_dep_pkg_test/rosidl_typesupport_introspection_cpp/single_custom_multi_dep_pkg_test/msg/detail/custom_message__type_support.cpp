...
{
  new (message_memory) single_custom_multi_dep_pkg_test::msg::CustomMessage(_init);
}

void CustomMessage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<single_custom_multi_dep_pkg_test::msg::CustomMessage *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CustomMessage_message_member_array[2] = {
  {
    ...
    offsetof(single_custom_multi_dep_pkg_test::msg::CustomMessage, center),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(single_custom_multi_dep_pkg_test::msg::CustomMessage, batter_info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CustomMessage_message_members = {
  "single_custom_multi_dep_pkg_test::msg",  // message namespace
  "CustomMessage",  // message name
  2,  // number of fields
  sizeof(single_custom_multi_dep_pkg_test::msg::CustomMessage),
...
{
  return &::single_custom_multi_dep_pkg_test::msg::rosidl_typesupport_introspection_cpp::CustomMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, single_custom_multi_dep_pkg_test, msg, CustomMessage)() {
  return &::single_custom_multi_dep_pkg_test::msg::rosidl_typesupport_introspection_cpp::CustomMessage_message_type_support_handle;
}
