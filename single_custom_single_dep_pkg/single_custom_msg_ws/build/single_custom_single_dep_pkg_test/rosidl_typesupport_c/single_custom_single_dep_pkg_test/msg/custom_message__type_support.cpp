...
#include "single_custom_single_dep_pkg_test/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _CustomMessage_type_support_symbol_names_t _CustomMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, single_custom_single_dep_pkg_test, msg, CustomMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, single_custom_single_dep_pkg_test, msg, CustomMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_single_custom_single_dep_pkg_test
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, single_custom_single_dep_pkg_test, msg, CustomMessage)() {
  return &::single_custom_single_dep_pkg_test::msg::rosidl_typesupport_c::CustomMessage_message_type_support_handle;
}
