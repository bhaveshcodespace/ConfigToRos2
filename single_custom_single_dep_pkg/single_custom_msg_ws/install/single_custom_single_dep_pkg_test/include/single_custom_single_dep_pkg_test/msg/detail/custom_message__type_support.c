...
#include <stddef.h>
#include "single_custom_single_dep_pkg_test/msg/detail/custom_message__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  single_custom_single_dep_pkg_test__msg__CustomMessage__init(message_memory);
}

void CustomMessage__rosidl_typesupport_introspection_c__CustomMessage_fini_function(void * message_memory)
{
  single_custom_single_dep_pkg_test__msg__CustomMessage__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember CustomMessage__rosidl_typesupport_introspection_c__CustomMessage_message_member_array[2] = {
  {
    ...
    offsetof(single_custom_single_dep_pkg_test__msg__CustomMessage, center),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(single_custom_single_dep_pkg_test__msg__CustomMessage, radius),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CustomMessage__rosidl_typesupport_introspection_c__CustomMessage_message_members = {
  "single_custom_single_dep_pkg_test__msg",  // message namespace
  "CustomMessage",  // message name
  2,  // number of fields
  sizeof(single_custom_single_dep_pkg_test__msg__CustomMessage),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_single_custom_single_dep_pkg_test
